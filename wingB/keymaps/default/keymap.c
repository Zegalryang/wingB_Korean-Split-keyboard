...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT(
     KC_PSCR,KC_BRMD,KC_PAUS,_______,_______,_______,                       _______,_______,_______,_______,_______,_______,
     _______,KC_PGUP,KC_UP  ,KC_PGDN,KC_INS ,KC_HOME,                       _______,_______,_______,_______,_______,_______,
